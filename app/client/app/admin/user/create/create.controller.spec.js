/**
 * @ngdoc controller
 * @name appApp.admin.user.create.controller:UserCreateController
 * @description
...
(function () {
  ...
  angular
    .module('appApp.admin.user.create')
    .controller('UserCreateController', UserCreateController);

  /**
   * @ngdoc function
   * @name appApp.admin.user.create.provider:UserCreateController
   * @description
   * Provider of the {@link appApp.admin.user.create.controller:UserCreateController UserCreateController}
   *
   ...
   * @returns {Service} {@link appApp.admin.user.create.controller:UserCreateController UserCreateController}
   */
  ...
  function UserCreateController($mdDialog, Auth, User, Toast) {
     ...
     * @ngdoc property
     * @name userRoles
     * @propertyOf appApp.admin.user.create.controller:UserCreateController
     * @description
     ...
     * @ngdoc function
     * @name create
     * @methodOf appApp.admin.user.create.controller:UserCreateController
     * @description
