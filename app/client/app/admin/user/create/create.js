/**
 * @ngdoc overview
 * @name appApp.admin.user.create
 * @description
 * The `appApp.admin.user.create` module which provides
 *
 * - {@link appApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
