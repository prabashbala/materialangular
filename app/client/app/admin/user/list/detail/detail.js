/**
 * @ngdoc overview
 * @name appApp.admin.user.list.detail
 * @description
 * The `appApp.admin.user.list.detail` module which provides:
 *
 * - {@link appApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires appApp.auth.user
 */
(function () {
  'use strict';
