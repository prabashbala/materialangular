/**
 * @ngdoc controller
 * @name appApp.admin.user.list.detail.controller:UserDetailController
 * @description
...
(function () {
   ...
   */
  angular
    .module('appApp.admin.user.list.detail')
    .controller('UserDetailController', UserDetailController);

  /**
   * @ngdoc function
   * @name appApp.admin.user.list.detail.provider:UserDetailController
   * @description
   * Provider of the {@link appApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
   *
   ...
   * @returns {Service} {@link appApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
   */
  ...
  function UserDetailController($state, user, Auth) {
     ...
     * @ngdoc property
     * @name user
     * @propertyOf appApp.admin.user.list.detail.controller:UserDetailController
     * @description
     ...
     * @ngdoc function
     * @name edit
     * @methodOf appApp.admin.user.list.detail.controller:UserDetailController
     * @description
