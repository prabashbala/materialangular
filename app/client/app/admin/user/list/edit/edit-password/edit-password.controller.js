/**
 * @ngdoc controller
 * @name appApp.admin.user.list.edit.controller:EditPasswordController
 * @description
...
(function () {
  ...
  angular
    .module('appApp.admin.user.list.edit')
    .controller('EditPasswordController', EditPasswordController);


  /**
   * @ngdoc function
   * @name appApp.admin.user.list.edit.provider:EditPasswordController
   * @description
   * Provider of the {@link appApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
   *
   ...
   * @returns {Service} {@link appApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
   */
  ...
  function EditPasswordController($mdDialog, UserService, user, Toast) {
     ...
     * @ngdoc function
     * @name changePassword
     * @methodOf appApp.admin.user.list.edit.controller:EditPasswordController
     * @description
