/**
 * @ngdoc controller
 * @name appApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
  ...
  /**
   * @ngdoc function
   * @name appApp.admin.user.list.edit.provider:UserEditController
   * @description
   * Provider of the {@link appApp.admin.user.list.edit.controller:UserEditController UserEditController}
