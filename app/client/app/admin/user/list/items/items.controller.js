/**
 * @ngdoc controller
 * @name appApp.admin.user.list.items.controller:UserItemsController
 * @description
...
(function () {
  ...
  /**
   * @ngdoc function
   * @name appApp.admin.user.list.items.provider:UserItemsController
   * @description
   * Provider of the {@link appApp.admin.user.list.items.controller:UserItemsController UserItemsController}
   *
   */
  ...
  function UserItemsController($state, Auth) {
     ...
     * @ngdoc function
     * @name isSelected
     * @methodOf appApp.admin.user.list.items.controller:UserItemsController
     * @description
